...
// GENERATORS
  ...
  iPSL.Electrical.Machines.Eurostag.PwGeneratorM2S gen_pwGeneratorM2S__GEN____8_SM (
	 ...
	 snd = 0, 
	 snq = 0, 
	 init_theta = -0.2333962375313499, 
	 init_omega = 1.0, 
	 init_efd = 0.5618970230852507, 
	 WLMDVPu = 0.6682075874254081, 
	 init_lambdaad = -1.103409119028706, 
	 init_cm = 1.684807106733593e-05, 
	 init_lambdaq1 = 1.237656218036987e-05, 
	 init_lambdaq2 = 1.237656218036987e-05, 
	 init_iq = 3.516068801232702e-05, 
	 init_id = 0.1596330362208028, 
	 init_lambdaaq = 1.237656218036987e-05, 
	 init_lambdad = -1.103409119028706, 
	 init_lambdaf = -1.303309664352806,
	 PNALT = 228.0,
	 IENR = 3,
	 DIn = 0.0,
	 HIn = 2.748,
...
// REGULATORS
  ...
  iPSL.Electrical.Controls.Eurostag.sexs reg_sexs__GEN____8_SM (
	 ...
	 PNALT = 228.0,
	 init_EFD = 0.5618970230852507,
	 init_VREF = 1.09919472088846,
	 init_YLL = 0.002809485115426254,
	 TE = 0.05,
	 KC = 1.,
	 K = 200.,
	 EMIN = 0.,
  ...
  iPSL.Electrical.Controls.Eurostag.gsteam0 reg_gsteam0__GEN____8_SM (
	 ...
	 PN = 242.0,
	 PNALT = 228.0,
	 init_REF = 8.424035533667964e-07,
	 init_PMECH = 1.684807106733593e-05,
	 init_CM = 1.684807106733593e-05,
	 DT = 0.,
	 RR = 0.05,
	 VMIN = 0.,
...
equation
  connect(omegaRef.pin_HIn[1], gen_pwGeneratorM2S__GEN____1_SM.pin_HIn);
  connect(omegaRef.pin_HIn[2], gen_pwGeneratorM2S__GEN____2_SM.pin_HIn);
  connect(omegaRef.pin_HIn[3], gen_pwGeneratorM2S__GEN____3_SM.pin_HIn);
  connect(omegaRef.pin_HIn[4], gen_pwGeneratorM2S__GEN____6_SM.pin_HIn);
  connect(omegaRef.pin_HIn[5], gen_pwGeneratorM2S__GEN____8_SM.pin_HIn);

  connect(omegaRef.pin_SN[1], gen_pwGeneratorM2S__GEN____1_SM.pin_SN);
  connect(omegaRef.pin_SN[2], gen_pwGeneratorM2S__GEN____2_SM.pin_SN);
  connect(omegaRef.pin_SN[3], gen_pwGeneratorM2S__GEN____3_SM.pin_SN);
  connect(omegaRef.pin_SN[4], gen_pwGeneratorM2S__GEN____6_SM.pin_SN);
  connect(omegaRef.pin_SN[5], gen_pwGeneratorM2S__GEN____8_SM.pin_SN);

  connect(omegaRef.pin_omega[1], gen_pwGeneratorM2S__GEN____1_SM.pin_OMEGA);
  connect(omegaRef.pin_omega[2], gen_pwGeneratorM2S__GEN____2_SM.pin_OMEGA);
  connect(omegaRef.pin_omega[3], gen_pwGeneratorM2S__GEN____3_SM.pin_OMEGA);
  connect(omegaRef.pin_omega[4], gen_pwGeneratorM2S__GEN____6_SM.pin_OMEGA);
  connect(omegaRef.pin_omega[5], gen_pwGeneratorM2S__GEN____8_SM.pin_OMEGA);
  ...
  connect(omegaRef.omegaRef, gen_pwGeneratorM2S__GEN____3_SM.omegaRef);
