...
model _GEN___13_SM_Initialization
 ...
 (
  ...
  Modelica.Blocks.Sources.Constant zero__GEN___13_SM (k = 0) annotation (Placement(transformation()));
    equation
    ...
    connect(sexs__GEN___13_SM.pin_VS, zero__GEN___13_SM.y) annotation (Line());
