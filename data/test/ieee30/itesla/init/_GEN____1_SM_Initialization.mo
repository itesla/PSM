...
model _GEN____1_SM_Initialization
 ...
 (
  ...
  Modelica.Blocks.Sources.Constant zero__GEN____1_SM (k = 0) annotation (Placement(transformation()));
    equation
    ...
    connect(sexs__GEN____1_SM.pin_VS, zero__GEN____1_SM.y) annotation (Line());
