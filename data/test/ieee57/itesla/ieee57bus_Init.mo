...
model _BEAV___6_SM_Initialization
    iPSL.Electrical.Machines.Eurostag.PwGeneratorM2S_Init gen_pwGeneratorM2S__BEAV___6_SM
   (
	PNALT = 1008.0,
	p0 = 0.0,
	omega_0 = 1.0,
  ...
  iPSL.Electrical.Controls.Eurostag.sexs_Init sexs__BEAV___6_SM
 (
	PNALT = 1008.0,
	K = 200.,
	EMIN = 0.,
  ...
  iPSL.Electrical.Controls.Eurostag.gsteam0_Init gsteam0__BEAV___6_SM
 (
	DT = 0.,
	RR = 0.05,
	PNALT = 1008.0,
  ...
  iPSL.Electrical.Controls.Eurostag.pssi3e2b_Init pssi3e2b__BEAV___6_SM
 (
	PNALT = 1008.0,
	KS1 = 10.,
	VSI1MAX = 999.,
...
model _GLEN__12_SM_Initialization
    iPSL.Electrical.Machines.Eurostag.PwGeneratorM2S_Init gen_pwGeneratorM2S__GLEN__12_SM
   (
	PNALT = 1539.0,
	p0 = 3.1,
	omega_0 = 1.0,
  ...
  iPSL.Electrical.Controls.Eurostag.sexs_Init sexs__GLEN__12_SM
 (
	PNALT = 1539.0,
	K = 200.,
	EMIN = 0.,
  ...
  iPSL.Electrical.Controls.Eurostag.pssi3e2b_Init pssi3e2b__GLEN__12_SM
 (
	PNALT = 1539.0,
	KS1 = 10.,
	VSI1MAX = 999.,
  ...
  iPSL.Electrical.Controls.Eurostag.gsteam0_Init gsteam0__GLEN__12_SM
 (
	DT = 0.,
	RR = 0.05,
	PNALT = 1539.0,
