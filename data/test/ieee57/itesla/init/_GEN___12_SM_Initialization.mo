...
model _GEN___12_SM_Initialization
    iPSL.Electrical.Machines.Eurostag.PwGeneratorM2S_Init gen_pwGeneratorM2S__GEN___12_SM
   (
	PNALT = 1539.0,
	p0 = 3.1,
	omega_0 = 1.0,
  ...
  iPSL.Electrical.Controls.Eurostag.pssi3e2b_Init pssi3e2b__GEN___12_SM
 (
	PNALT = 1539.0,
	KS1 = 10.,
	VSI1MAX = 999.,
  ...
  iPSL.Electrical.Controls.Eurostag.sexs_Init sexs__GEN___12_SM
 (
	PNALT = 1539.0,
	K = 200.,
	EMIN = 0.,
  ...
  iPSL.Electrical.Controls.Eurostag.gsteam0_Init gsteam0__GEN___12_SM
 (
	DT = 0.,
	RR = 0.05,
	PNALT = 1539.0,
  ...
  Modelica.Blocks.Sources.Constant zero__GEN___12_SM (k = 0) annotation (Placement(transformation()));
    equation
    ...
    connect(sexs__GEN___12_SM.pin_VS, zero__GEN___12_SM.y) annotation (Line());
