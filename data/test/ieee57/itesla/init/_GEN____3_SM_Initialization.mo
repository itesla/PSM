...
model _GEN____3_SM_Initialization
 ...
 (
  ...
  Modelica.Blocks.Sources.Constant zero__GEN____3_SM (k = 0) annotation (Placement(transformation()));
    equation
    ...
    connect(sexs__GEN____3_SM.pin_VS, zero__GEN____3_SM.y) annotation (Line());
