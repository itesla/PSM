...
// REGULATORS
 ...
 // INFINITE BUS
 iPSL.Electrical.Buses.InfiniteBusEuro INF______TN (
 V_0 = 1.1026396751403809, 
 angle_0 = -8.519973700730901e-07, 
 R = 0.00438, 
 X = 0.0438
...
equation
  connect(gen_pwGeneratorM2S__GEN______SM.omegaRef, omegaRef.y) annotation (Line());
...
// Connecting LINES
  ...
  connect(bus__INF______TN.p, INF______TN.p) annotation (Line());
// COUPLING DEVICES
