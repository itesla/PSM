...
public class MainApp extends Application
{
	...
	public FXMLLoader showConversionView(MainService mainService, Workflow w)
	{
		...
		else
		{
			...
			else
			{
				...
				return showConversionDetailView(mainService, true, null, checkOnly, null);
			}
		}
	}
	...
	public FXMLLoader showConversionDetailView(MainService mainService, boolean loadWorkflow,
			Case c, boolean onlyCheck, Diagnostics diagnostics)
	{
		...
		FXMLLoader loader = this.getFXMLLoader("view/ConversionDetail.fxml", w, onlyCheck, diagnostics);
		if (c != null)
		{
	...
	public FXMLLoader showSwtoswValidationView(MainService mainService, Workflow w)
	{
	...
	public void showConversionResult(MainService mainService, Case c)
	{
		...
		showConversionDetailView(mainService, false, c, false, null);
	}
