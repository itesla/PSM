...
public class WorkflowStatusControllerTest extends ApplicationTest {
	...
	public void testProgressView() throws InterruptedException {
		...
		DynamicTreeView<ProgressData> treeView = (DynamicTreeView) lookup("#treeView").query();
		...
		assertEquals("Start test workflow", treeView.getItems().get(0).getChildren().get(0).toString());
		...
		assertEquals("End test workflow", treeView.getItems().get(0).getChildren().get(6).toString());
		assertEquals("fake1", treeView.getItems().get(1).getTaskId());
		assertEquals(7, treeView.getItems().get(1).getChildren().size());
		assertEquals("Start test workflow", treeView.getItems().get(1).getChildren().get(0).toString());
		...
		assertEquals("End test workflow", treeView.getItems().get(1).getChildren().get(6).toString());
		assertEquals("fake2", treeView.getItems().get(2).getTaskId());
		assertEquals(7, treeView.getItems().get(2).getChildren().size());
		assertEquals("Start test workflow", treeView.getItems().get(2).getChildren().get(0).toString());
		...
		assertEquals("End test workflow", treeView.getItems().get(2).getChildren().get(6).toString());
		assertEquals("fake3", treeView.getItems().get(3).getTaskId());
		assertEquals(7, treeView.getItems().get(3).getChildren().size());
		assertEquals("Start test workflow", treeView.getItems().get(3).getChildren().get(0).toString());
		...
		assertEquals("End test workflow", treeView.getItems().get(3).getChildren().get(6).toString());
		assertEquals("fake4", treeView.getItems().get(4).getTaskId());
		assertEquals(7, treeView.getItems().get(4).getChildren().size());
		assertEquals("Start test workflow", treeView.getItems().get(4).getChildren().get(0).toString());
		...
		assertEquals("End test workflow", treeView.getItems().get(4).getChildren().get(6).toString());
	}
